...
namespace Mut8
{
    ...
    internal class MapScreen : ScreenObject
    {
        ...
        public MapScreen(MyGameMap map)
        {
            ...
            IFont kenneyFont = GameHost.Instance.Fonts["kenney_1-bit"];
            Point viewSize = new Point(Program.Width, Program.Height - MessageLogHeight).TranslateFont(GameHost.Instance.DefaultFont.GetFontSize(IFont.Sizes.One), kenneyFont.GetFontSize(IFont.Sizes.One));
            Map.DefaultRenderer = Map.CreateRenderer(viewSize, kenneyFont);
